...
PartialAmountModel partialAmountModelFromJson(String str) => PartialAmountModel.fromJson(json.decode(str));

String partialAmountModelToJson(PartialAmountModel data) => json.encode(data.toJson());
...
class PartialAmountModel {
    ...
    factory PartialAmountModel.fromJson(Map<String, dynamic> json) => PartialAmountModel(
