...
GetHotelRoomModel getHotelRoomModelFromJson(String str) => GetHotelRoomModel.fromJson(json.decode(str));

String getHotelRoomModelToJson(GetHotelRoomModel data) => json.encode(data.toJson());
...
class GetHotelRoomModel {
    ...
    factory GetHotelRoomModel.fromJson(Map<String, dynamic> json) => GetHotelRoomModel(
        userIp: json["UserIp"],
...
class RoomCombinations {
    ...
    factory RoomCombinations.fromJson(Map<String, dynamic> json) => RoomCombinations(
        infoSource: json["InfoSource"],
        isPolicyPerStay: json["IsPolicyPerStay"],
