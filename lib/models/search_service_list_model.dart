...
SearchServiceList searchServiceListFromJson(String str) =>
    SearchServiceList.fromJson(json.decode(str));

String searchServiceListToJson(SearchServiceList data) =>
...
class SearchServiceList {
  ...
  factory SearchServiceList.fromJson(Map<String, dynamic> json) =>
      SearchServiceList(
        message: json["message"],
        data: List<SearchServiceListData>.from(
            json["data"].map((x) => SearchServiceListData.fromJson(x))),
      );
