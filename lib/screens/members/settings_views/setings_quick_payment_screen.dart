...
class QucikPaymentScreen extends StatefulWidget {
  const QucikPaymentScreen({super.key});

  @override
  State<QucikPaymentScreen> createState() => _QucikPaymentScreenState();
}

class _QucikPaymentScreenState extends State<QucikPaymentScreen> {
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      boxShadow: [
                                        if (settingsController.index.value ==
                                            index)
                                          const BoxShadow(
                          ...
                          child: InkWell(
                            onTap: () {
                              ...
                              Get.to(() => PartialAddPAymentView(
                                    planId: plansController
                                        .plansdataList[
                                            settingsController.index.value]
                                        .id
                                        .toString(),
                                    saleAmount: plansController
                                        .plansdataList[
                                            settingsController.index.value]
                                        .saleAmount,
                                  ));
