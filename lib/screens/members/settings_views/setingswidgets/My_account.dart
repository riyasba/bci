  ...
  setDefault() async {
    ...
    if (profileController.profileData.isNotEmpty) {
      ...
      qualificationController.text =
          profileController.profileData.first.qualification;
      ...
      proofidController.text =
          profileController.profileData.first.officialAddress.proofIdNo;
      pincodeController.text =
          profileController.profileData.first.officialAddress.pincode;
      ...
      rproofidController.text =
          profileController.profileData.first.residentialAddress.personalId;
      rpincodeController.text =
