  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: holidayPackageController.getPackageDetailsData.isEmpty
            ? const Text("")
            : Text(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      holidayPackageController
                                              .getPackageDetailsData.isEmpty
                                          ? Text("")
                                          : Text(' ₹ ${holidayPackageController.getPackageDetailsData.first.amount}')
                                              .text
                                              .bold
                                              .xl2
                                              .blue900
              ...
              Obx(
                () => Padding(
                  ...
                  child: Container(
                    child: Column(
                      children: [
                        if (holidayController.reindex.value == 0)
                          OverviewWidget(
                            packageid: widget.packageId,
                          ),
                        if (holidayController.reindex.value == 1)
                          HotelDetails(
                            packageid: widget.packageId,
                          ),
                        if (holidayController.reindex.value == 2)
                          DayWiseItinerary(
                            packageid: widget.packageId,
                          ),
                        if (holidayController.reindex.value == 3)
