...
class PaymentWebViewServices extends StatefulWidget {
  double amount;
  String url;
  String referenceId;

  PaymentWebViewServices(
      {required this.amount, required this.referenceId, required this.url});

  @override
  State<PaymentWebViewServices> createState() => _PaymentWebViewState();
}

class _PaymentWebViewState extends State<PaymentWebViewServices> {
        ...
        child: SafeArea(
          ...
          onPageFinished: (String url) async {
            ...
            if (url.trim() ==
              ...
              Get.find<ProfileController>().checkPhonePeStatus(
