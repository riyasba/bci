...
class PaymentWebViewAddToWallet extends StatefulWidget {
  double amount;
  String url;
  String referenceId;
  String userId;

  PaymentWebViewAddToWallet({
  ...
  @override
  State<PaymentWebViewAddToWallet> createState() =>
      _PaymentWebViewAddToWalletState();
}

class _PaymentWebViewAddToWalletState extends State<PaymentWebViewAddToWallet> {
