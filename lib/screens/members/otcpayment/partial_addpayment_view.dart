...
class PartialAddPAymentView extends StatefulWidget {
  String saleAmount;
  String planId;
  PartialAddPAymentView(
      {super.key, required this.planId, required this.saleAmount});

  @override
  State<PartialAddPAymentView> createState() => _AddWaletScreenState();
}

class _AddWaletScreenState extends State<PartialAddPAymentView> {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              plansController.initiatePaymentPartialPayment(
                  planId: widget.planId,
                  saleAmount: widget.saleAmount,
                  status: "Pending",
                  collectedAmount: amountController.text,
                  collectedDate:
                      formatDate(DateTime.now(), [yyyy, "-", mm, "-", dd]),
                  customerId: profileController.profileData.first.id,
