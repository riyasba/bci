...
class AirportSearchScreenChoose extends StatefulWidget {
  const AirportSearchScreenChoose({super.key});

  @override
  State<AirportSearchScreenChoose> createState() => _flightScreenChoose2State();
}

class _flightScreenChoose2State extends State<AirportSearchScreenChoose> {
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                onTap: () {
                                                  ...
                                                  flightsController.originCountry(
                                                      flightsController
                                                          .searchlistsearchList[
                                                              i]
                                                          .countrycode);
